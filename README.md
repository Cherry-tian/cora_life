## 疫生活小程序
旨在疫情期间社区互助，新闻咨询，生活分享等。本项目为小程序的前端项目
...
* 支持在首页对`分享`进行点赞、收藏
<img decoding="async" src="./assets/image/readme/%E9%A6%96%E9%A1%B5.PNG" width="40%">
...
### 新闻页
* 官方认证账号才可发表`新闻`，`新闻`可以涉及防疫政策变化、社区通知等
* 支持点击跳转到详情页，做进一步的用户互动
<img decoding="async" src="./assets/image/readme/%E6%96%B0%E9%97%BB%E9%A1%B5.PNG" width="40%">

### 消息页
* 包括官方消息、评论消息、新增粉丝消息、`分享`被点赞收藏的消息
<img decoding="async" src="./assets/image/readme/%E6%B6%88%E6%81%AF%E9%A1%B5.PNG" width="40%">

### 个人主页
* 展示用户个人信息、数据统计、关注及粉丝
* 展示用户以往发布、收藏、点赞的`分享`和`新闻`
<img decoding="async" src="./assets/image/readme/%E4%B8%AA%E4%BA%BA%E4%B8%BB%E9%A1%B5.PNG" width="40%">

### 用户信息编辑页
* 支持用户更换昵称、描述和头像
<img decoding="async" src="./assets/image/readme/%E7%94%A8%E6%88%B7%E4%BF%A1%E6%81%AF%E7%BC%96%E8%BE%91.PNG" width="40%">

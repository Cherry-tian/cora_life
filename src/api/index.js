...
const domainProd = "www.yeball.top"

// 获取 api path 前缀
const getPathPrefix = () => {
    // return "http://" + domainMock
    // return "http://" + domainDev
    return "https://" + domainProd // prod调线上接口是 https, 测试是 http
}
...
const unFollowUserPath = "/api/user/unfollow" // 取消关注用户
const followUserPath = "/api/user/follow" // 关注用户
